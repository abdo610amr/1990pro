        ...
        >
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 rounded-2xl bg-secondary/50 p-4">
            <div className="text-center">
              ...
              <p className="mt-2 text-xs text-muted-foreground">Free shipping over $200</p>
            </div>
            <div className="text-center">
          ...
          <Accordion className="mt-8">
            ...
            <AccordionItem value="shipping">
              ...
              <AccordionContent className="text-muted-foreground">
                <p>Standard shipping: 3-5 business days ($15, free over $200).</p>
                <p className="mt-2">Express shipping: 1-2 business days ($25).</p>
