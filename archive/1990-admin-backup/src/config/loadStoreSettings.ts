...
function mergeWithDefaults(partial: Partial<StoreSettings>): StoreSettings {
  return {
    brandId: partial.brandId ?? "1990",
    storeName: partial.storeName ?? "1990",
    tagline: partial.tagline ?? "Made For Originals",
    theme: {
    ...
    heroBanner: {
      ...
      title: partial.heroBanner?.title ?? "Made For Originals",
      subtitle: partial.heroBanner?.subtitle ?? "Your commerce command center",
    },
  };
}
