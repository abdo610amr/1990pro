    ...
    <div className="luxury-container luxury-section">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-6 text-muted-foreground">
          <p>
            We ship to all governorates across Egypt. All orders are processed
          ...
          <ul className="list-inside list-disc space-y-2">
            <li>
              ...
              business days ({formatPrice(SHIPPING_COST)}, free on orders over{" "}
              {formatPrice(FREE_SHIPPING_THRESHOLD)})
            </li>
            <li>
              <strong className="text-foreground">Express</strong> — 1–2
              business days ({formatPrice(EXPRESS_SHIPPING_COST)})
            </li>
          </ul>
          <h2 className="font-heading text-xl font-light text-foreground">
            Tracking
