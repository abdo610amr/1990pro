...
export function ProductFormDialog({
  ...
  const [variantType, setVariantType] = useState<VariantType>("perfume-volume");
  const [variantLabel, setVariantLabel] = useState("Volume");
  ...
  useEffect(() => {
    if (product) {
      ...
      setVariantType(product.variantType ?? "perfume-volume");
      setVariantLabel(product.variantLabel ?? "Volume");
      ...
      const defaults = platformConfig ?? {
        variantType: "perfume-volume" as VariantType,
        variantLabel: "Volume",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {platformConfig?.productType === "fashion"
              ? "Fashion mode: products use Size variants (S–XXL) by default."
              : "Perfume mode: products use Volume variants by default."}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {variants.map((variant, index) => (
                <div key={index} className="grid grid-cols-[1fr_80px_80px_1fr_auto] gap-2">
                  <Input
                    placeholder="Label"
                    value={variant.label}
